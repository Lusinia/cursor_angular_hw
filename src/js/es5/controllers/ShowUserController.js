...
(function () {
    ...
    shopApp.controller("ShowUserController", ["$scope", "$localStorage", "$location", "usersFactory", function ($scope, $localStorage, $location, usersFactory) {
        ...
        var handlerError = function handlerError(err) {
            console.log(err);
        };
        ...
        $scope.saveChanges = function (name, oldPassword, newPassword, newPassword2) {
